// test constant-folding casts from integer types to double
...
// (From double-rounding example in Chapter 13, "Converting an Unsigned Integer to a double")
double target_from_long(void) { return (double) 4611686018427388416l; }

// convert a value outside the range of signed long
// (From double-rounding example in Chapter 13, "Converting an Unsigned Integer to a double")
double target_from_ulong(void) { return (double) 9223372036854776833ul; }
