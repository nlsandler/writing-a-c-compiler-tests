// force us to spill temporary results of various aritihmetic expressions to make sure rewrite rules still work
...
int target(int one, int two, int three, int four, int five, int six)
{
     ...
     */
    int imul_result = glob * glob2;
    int add_result = glob + glob2;
    int sub_result = glob2 - glob;
    ...
    return result2 + imul_result + add_result + sub_result;
}
