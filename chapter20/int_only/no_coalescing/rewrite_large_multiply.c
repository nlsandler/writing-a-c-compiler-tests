// force us to spill temporary results of multiply by large constant to make sure rewrite rules still work
...
int target(int one, int two, int three, int four, int five, int six)
{
     ...
     */
    long imul_result = glob3 * 4294967307l;
