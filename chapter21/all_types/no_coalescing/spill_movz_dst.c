// force us to spill temporary results of movz to make sure rewrite rules still work
...
int glob = 3;
int glob2 = 4;
unsigned char glob3 = 5;
unsigned glob4 = 10;
double glob5 = 11.0;

long target(int one, int two, int three, int four, int five, int six)
{
     ...
     */
    int movz_result = (int) glob3;
    long movz_result_2 = (long) glob4;
    int cvttsd2si_result = (int) glob5;
    ...
    return result2 + movz_result + movz_result_2 + cvttsd2si_result;
}
